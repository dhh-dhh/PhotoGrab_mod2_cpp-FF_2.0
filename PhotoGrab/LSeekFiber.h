...
public:
	...
	void NiheParam(CString strFileName);
	int		m_nTop;
	int		m_nBottom;
...
protected:
	...
	void WriteMicronTxt(CString str);
	...
	double* pixelPCoorX1;					//工作光纤点角度坐标，intPNum个，预存
	double* pixelPCoorY1;					//工作光纤点角度坐标，intPNum个，预存
	...
	double* FFCircleY;
	double FFCMax = 95;//FF圆最大探查半径
	double FFCMin = 75;//FF圆最小探查半径
